...
public class IndexInfo extends BaseUpdatableEntity {
  ...
  public IndexInfo(String indexClassification, String indexName, Integer itemCount,
      LocalDate basePointInTime, Integer baseIndex, SourceType sourceType, boolean favorite,
      boolean enabled) {
  ...
  public void update(Integer newItemCount, LocalDate newBasePointInTime, Integer newBaseIndex,
      boolean newFavorite) {
